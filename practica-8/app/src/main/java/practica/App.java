...
public class App {
    ...
    public static void start() {
        ...
        Cliente cliente1 = new Cliente(1, "cliente 1","2/10/1997");
        Cliente cliente2= new Cliente(2, "cliente 2","23/12/1994");
        Cliente cliente3= new Cliente(3, "cliente 3","18/02/2000");
                ...
                while ((linea=reader.readLine())!= null) {
                    ...
                    clientes.forEach(cliente -> {
                        if (cliente.getId()==idCliente){
                            Cuenta cuenta = null;
                            if (tipo.equals("CA")){
                                cuenta =  new CuentaDeAhorro(datos[0],Double.parseDouble(datos[2]),datos[1],
                                        Double.parseDouble(datos[3]));

                            }else if (tipo.equals("CC")){
                                cuenta =  new CuentaDeCheque(datos[0],Double.parseDouble(datos[2]),datos[1],
                                        Double.parseDouble(datos[3]));
                            }
